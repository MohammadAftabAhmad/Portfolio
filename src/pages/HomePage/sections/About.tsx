        ...
        <div className="relative z-10  max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12 ">
          ...
          >
            ...
            <div className="flex-1 flex flex-col  text-center md:text-left lg:text-left ">
              ...
              <p className="mt-2 text-lg sm:text-xl lg:text-3xl  font-semibold">
                Frontend Developer
              </p>
              ...
              <div className="flex gap-5  mt-5">
                ...
                <SiTypescript className="w-[30px] h-[30px] hover:scale-110 duration-300 text-[#3178C6]" />

                <FaNodeJs className="w-[30px] h-[30px] hover:scale-110 duration-300 text-[#8CC84B]" />
                <svg
                  className="hover:scale-110 duration-300"
                  width="30px"
                  height="30px"
                ...
                <RiTailwindCssFill className="w-[30px] h-[30px] hover:scale-110 duration-300 text-[#44A8B3]" />
                <svg
                  className="hover:scale-110 duration-300"
                  width="30px"
                  height="30px"
              ...
              <div className=" mt-3 flex flex-col-2  sm:flow-row gap-3  ">
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center rounded-lg order border-white/20 text-white px-5 py-3 bg-white/5 hover:bg-white/20 transition"
                >
                  Get in Touch
                </a>
              </div>
